...
> **Версия документа:** 2.2 — C2 исправлен, S2 исправлен (предрезолвинг выключен по умолчанию).
...
| Сборка и гигиена | 15% | 7/10 | Актуальные версии, ktlint; мёртвые proguard-правила, неиспользуемый OKHttp; C2 и S2 исправлены |

| Взвешенная сумма: `8·0.25 + 9·0.30 + 5·0.20 + 3·0.10 + 7·0.15 = 7.15 ≈ 7/10` |
...
3. [ ] M4: права 600 на `hev-socks5-tunnel.yaml`, убрать `Log.d` с содержимым конфига.

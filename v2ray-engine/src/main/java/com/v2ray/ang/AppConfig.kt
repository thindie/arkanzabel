...
object AppConfig {
  /**
   * Host app [android.content.Context.getPackageName] / applicationId.
   * Set from [initHostApplicationId] in Application.onCreate before any engine code runs.
   */
  @Volatile
  ...
  /** Broadcast actions (depend on [ANG_PACKAGE]). */
  val BROADCAST_ACTION_SERVICE get() = "$ANG_PACKAGE.action.service"
  val BROADCAST_ACTION_ACTIVITY get() = "$ANG_PACKAGE.action.activity"
  val BROADCAST_ACTION_WIDGET_CLICK get() = "$ANG_PACKAGE.action.widget.click"
...
//    const val IP_API_URL = "https://speed.cloudflare.com/meta"
  ...
  const val MSG_STATE_SAVE_PROFILE = 55

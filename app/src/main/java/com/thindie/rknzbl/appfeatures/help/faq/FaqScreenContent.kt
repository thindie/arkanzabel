    ...
    Column(
      ...
      Column(modifier = Modifier.padding(horizontal = 16.dp)) {
        ...
        FaqLegendItem(
          ...
          label = stringResource(R.string.faq_legend_proxy),
        )
        VSpacer(4.dp)
        FaqLegendItem(
          iconRes = EngineR.drawable.ic_stat_direct,
          label = stringResource(R.string.faq_legend_direct),
        )
        VSpacer(4.dp)
        FaqLegendItem(
          iconRes = EngineR.drawable.ic_stat_name,
          label = stringResource(R.string.faq_legend_idle),
        )
        VSpacer(8.dp)
